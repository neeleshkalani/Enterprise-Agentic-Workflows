...
- [Executive Summary](#executive-summary)
  ...
  - [What is intentionally simulated](#what-is-intentionally-simulated)
...
- [3. Technical Architecture](#3-technical-architecture)
  ...
  - [Agent and model boundary](#agent-and-model-boundary)
  - [Persistence](#persistence)
  - [Tool boundary](#tool-boundary)
- [4. Why The Control Plane Matters](#4-why-the-control-plane-matters)
  - [Implemented control plane](#implemented-control-plane)
    - [Workflow and approval gates](#1-workflow-and-approval-gates)
    - [Explicit state outside agent memory](#2-explicit-state-outside-agent-memory)
    - [Bounded clarification](#3-bounded-clarification)
    - [Typed contracts and deterministic evaluations](#4-typed-contracts-and-deterministic-evaluations)
    - [Revision and invalidation](#5-revision-and-invalidation)
    - [Model observability](#6-model-observability)
    - [Governed MCP tools](#7-governed-mcp-tools)
    - [Audit trail](#8-audit-trail)
- [5. Evaluation: What Is Measured Today](#5-evaluation-what-is-measured-today)
  - [Current deterministic checks](#current-deterministic-checks)
  - [Why this is still useful](#why-this-is-still-useful)
...
- [7. Enterprise Target State](#7-enterprise-target-state)
  - [People and accountability](#people-and-accountability)
  - [Durable orchestration](#durable-orchestration)
  - [Immutable artifacts and lineage](#immutable-artifacts-and-lineage)
  - [Policy and budgets](#policy-and-budgets)
  - [Evaluation platform](#evaluation-platform)
  - [Secure tool execution](#secure-tool-execution)
  - [Enterprise MarTech integration](#enterprise-martech-integration)
- [8. Enterprise Value](#8-enterprise-value)
  - [Speed](#speed)
  - [Consistency](#consistency)
  - [Traceability](#traceability)
  - [Scalable control](#scalable-control)
- [9. Key Design Decisions](#9-key-design-decisions)
  - [Why a workbench rather than a chatbot?](#why-a-workbench-rather-than-a-chatbot)
  - [Why specialist agents?](#why-specialist-agents)
  - [Why explicit orchestration?](#why-explicit-orchestration)
  - [Why state outside the agents?](#why-state-outside-the-agents)
  - [Why simulated platform execution?](#why-simulated-platform-execution)
